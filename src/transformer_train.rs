...
use crate::tensor::{sgd_step, Tape};
...
pub fn train_transformer() {
    ...
    let vocab_size = 6; // characters: a=0, b=1, c=2, d=3, e=4, f=5
    let pattern: Vec<usize> = vec![0, 1, 2, 3, 4, 5]; // "abcdef"
    ...
    for epoch in 0..epochs {
        ...
        for s in 0..num_samples {
            ...
            // Target: one-hot encoded [seq_len, vocab_size]
    ...
    // Start with "abc" and predict the next characters
    ...
    for _ in 0..20 {
        ...
        // Use last seq_len tokens (or all if shorter)
